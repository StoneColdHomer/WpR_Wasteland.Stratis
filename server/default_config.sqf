...
A3W_boxSpawning = 1;               // If serverSpawning = 1, spawn weapon crates in up to configs value, e.g. 1 = all towns, 0.5 = 50 percent chance
...
A3W_territoryAllowed = [0,1,2,3,4,5];    //Territory Allowed (0:AGIA MARINA,1:AGIOS RIDGE,2:STRATIS AIRBASE,3:KAMINO,4:KILL FARM,5:PYTHOS)
