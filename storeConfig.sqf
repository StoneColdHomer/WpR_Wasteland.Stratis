...
["Mk-1 EMR 7.62mm (Black) [DLC]", "srifle_DMR_03_F", 500],
["Mk-1 EMR 7.62mm (Camo) [DLC]", "srifle_DMR_03_multicam_F", 525],
["Mk-1 EMR 7.62mm (Khaki) [DLC]", "srifle_DMR_03_khaki_F", 525],
["Mk-1 EMR 7.62mm (Tan) [DLC]", "srifle_DMR_03_tan_F", 525],
["Mk-1 EMR 7.62mm (Woodland) [DLC]", "srifle_DMR_03_woodland_F", 525],
["Mk14 7.62mm (Camo) [DLC]", "srifle_DMR_06_camo_F", 525],
["Mk14 7.62mm (Olive) [DLC]", "srifle_DMR_06_olive_F", 525],
["Cyrus 9.3mm (Black) [DLC]", "srifle_DMR_05_blk_F", 600],
["Cyrus 9.3mm (Hex) [DLC]", "srifle_DMR_05_hex_F", 625],
["Cyrus 9.3mm (Tan) [DLC]", "srifle_DMR_05_tan_f", 625],
	// Sniper Rifles
["MAR-10 .338 (Black) [DLC]", "srifle_DMR_02_F", 1000],
["MAR-10 .338 (Camo) [DLC]", "srifle_DMR_02_camo_F", 1150],
["MAR-10 .338 (Sand) [DLC]", "srifle_DMR_02_sniper_F", 1150],
...
["ASP-1 Kir 12.7mm (Black) [DLC]", "srifle_DMR_04_F", 1100],
["ASP-1 Kir 12.7mm (Tan) [DLC]", "srifle_DMR_04_Tan_F", 1250]
];
...
["Navid 9.3mm (Hex) [DLC]", "MMG_01_hex_F", 500],
["Navid 9.3mm (Tan) [DLC]", "MMG_01_tan_F", 500],
["SPMG .338 (Black) [DLC]", "MMG_02_black_F", 600],
["SPMG .338 (MTP) [DLC]", "MMG_02_camo_F", 625],
["SPMG .338 (Sand) [DLC]", "MMG_02_sand_F", 625]
];
...
["12.7mm 10Rnd Mag [DLC]", "10Rnd_127x54_Mag", 50],
	["9.3mm 10Rnd Mag [DLC]", "10Rnd_93x64_DMR_05_Mag", 50],
	["9.3mm 150Rnd Belt [DLC]", "150Rnd_93x64_Mag", 150], //DLC Ammo
	[".338 LM 10Rnd Mag [DLC]", "10Rnd_338_Mag", 50],
	[".338 NM 130Rnd Belt [DLC]", "130Rnd_338_Mag", 150], //DLC Ammo
...
[
	...
	["Suppressor .338 (Black) [DLC]", "muzzle_snds_338_black", 150, "item"],
	["Suppressor .338 (Green) [DLC]", "muzzle_snds_338_green", 150, "item"],
	["Suppressor .338 (Sand) [DLC]", "muzzle_snds_338_sand", 150, "item"],
	["Suppressor 9.3mm (Black) [DLC]", "muzzle_snds_93mmg", 150, "item"],
	["Suppressor 9.3mm (Tan) [DLC]", "muzzle_snds_93mmg_tan" ,150, "item"],
	["Bipod (Black) (AAF) [DLC]", "bipod_03_F_blk", 175, "item"],
	["Bipod (Black) (CSAT) [DLC]", "bipod_02_F_blk", 175, "item"],
	["Bipod (Black) (NATO) [DLC]", "bipod_01_F_blk", 175, "item"],
	["Bipod (Hex) (CSAT) [DLC]", "bipod_02_F_hex", 175, "item"],
	["Bipod (MTP) (NATO) [DLC]", "bipod_01_F_mtp", 175, "item"],
	["Bipod (Olive) (AAF) [DLC]", "bipod_03_F_oli", 175, "item"],
	["Bipod (Sand) (NATO) [DLC]", "bipod_01_F_snd", 175, "item"],
	["Bipod (Tan) (CSAT) [DLC", "bipod_02_F_tan", 175, "item"],
	...
	["AMS (Black) [DLC]", "optic_AMS", 175, "item"],
	["AMS (Khaki) [DLC]", "optic_AMS_khk", 175, "item"],
	["AMS (Tan) [DLC]", "optic_AMS_snd", 175, "item"],
...
["Carrier GL Rig (Black) [DLC]", "V_PlateCarrierGL_blk", -1, "vest"],
["Carrier GL Rig (MTP) [DLC]", "V_PlateCarrierGL_mtp", -1, "vest"],
...
["GA Carrier Rig (Olive) [DLC]", "V_PlateCarrierIAGL_oli", -1, "vest"],
	["GA Carrier GL Rig (Digi)", "V_PlateCarrierIAGL_dgtl", -1, "vest"],
["Carrier Special Rig (Black) [DLC]", "V_PlateCarrierSpec_blk", -1, "vest"],
["Carrier Special Rig (MTP) [DLC]", "V_PlateCarrierSpec_mtp", -1, "vest"],
